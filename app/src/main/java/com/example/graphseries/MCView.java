...
public class MCView extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_m_c_view, container, false);
    }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(f1==0 || f2==0)
                {
                    ...
                    bundle.putDoubleArray("message", m);
                    bundle.putDoubleArray("time", t);
                    bundle.putDoubleArray("carrier", c);
                    Modulation_view fragInfo = new Modulation_view();
